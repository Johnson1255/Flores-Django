"""
Django settings for flores_django project.
...
ROOT_URLCONF = 'flores_django.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [BASE_DIR / 'template'], # Corrected directory name to singular 'template'
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'flores_django.wsgi.application'
...
LANGUAGE_CODE = 'es' # Let's default to Spanish based on the project context
...
TIME_ZONE = 'UTC' # Keep as UTC unless specific timezone logic is needed
...
# Default URL to redirect to after login/logout
LOGIN_REDIRECT_URL = '/'
LOGOUT_REDIRECT_URL = '/'
